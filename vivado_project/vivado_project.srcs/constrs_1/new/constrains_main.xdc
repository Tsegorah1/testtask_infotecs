...
set_clock_groups -asynchronous -group [get_clocks *312_5*] -group [get_clocks clk_156_25] -group [get_clocks clk*125*] -group [get_clocks rxoutclk*] -group [get_clocks txoutclk*]
